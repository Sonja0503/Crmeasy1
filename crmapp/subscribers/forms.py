...
# Mixin klasa se ponasa kao i Parent klasa,ali se ne rade instance na nju,niti ona nasljeduje iz druge klase
...
class SubscriberForm(AddressMixin, UserCreationForm):
    first_name = forms.CharField(
        required=True, widget=forms.TextInput(attrs={'class': 'my-form-control'})
    )
