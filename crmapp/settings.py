...
if ENV_ROLE == 'development':
    DEBUG = True
    TEMPLATE_DEBUG = DEBUG
    # Primjer konstante- vrsta verijable. Pise se velikim slovima i _
    # moze dohvacati bilo gdje kasnije u kodu,ali joj se vrijednosti ne mijenjaju
